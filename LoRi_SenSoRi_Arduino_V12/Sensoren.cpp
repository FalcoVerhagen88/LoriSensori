...
void Sensoren::setTimeMetGps(NeoGPS::time_t & dt)
{
    ...
    setTime(fix.dateTime.hours,fix.dateTime.minutes,fix.dateTime.seconds,fix.dateTime.date,fix.dateTime.month,fix.dateTime.year);
            Serial.print("set time uren : ");
        Serial.println(hour());
        Serial.print("set time minuten : ");
        Serial.println(minute());
        Serial.print("set time seconden : ");
        Serial.println(second());
        Serial.print("set time dag : ");
        Serial.println(day());
        Serial.print("set time maand : ");
        Serial.println(month());
        Serial.print("set time jaar : ");
        Serial.println(year());
}

byte Sensoren::diefstalAlarm()
{
