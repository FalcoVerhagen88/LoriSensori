...
import com.lorisensori.application.service.MedewerkerServiceClass;
...
public class MedewerkerControllerAuth {

	private static final Logger logger = Logger.getLogger(MedewerkerControllerAuth.class);

	private final AuthService authService;

	private final MedewerkerServiceClass userService;

	private final ApplicationEventPublisher applicationEventPublisher;

	@Autowired
	public MedewerkerControllerAuth(AuthService authService, MedewerkerServiceClass userService, ApplicationEventPublisher applicationEventPublisher) {
