...
// ---------------------------------------- Opstellen acknowledge slotstandwijziging ----------------------------------------//
  ...
  void Uplink::ackSluitingstijdWijziging(AckSluitingstijdW *p)
  {
  ...
  void Uplink::ackOpeningstijdWijziging(AckOpeningstijdW *p)
  {
...
TankUl Uplink::getAliveBericht(Sensoren *s)   //bekijkt welk bericht/status tank
 {
  ...
  /*
   * nog een ackbericht toevoegen om een weekendseting wijziging te bevesigen
   */
